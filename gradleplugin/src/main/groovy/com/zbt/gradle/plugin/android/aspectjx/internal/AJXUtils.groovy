 ...
 */
package com.zbt.gradle.plugin.android.aspectjx.internal

import com.android.SdkConstants
import com.android.build.api.transform.*
import com.zbt.gradle.plugin.android.aspectjx.AJXPlugin
    ...
    static void fullCopyFiles(TransformInvocation transformInvocation) {
        ...
        transformInvocation.inputs.each { TransformInput input ->
            input.directoryInputs.each { DirectoryInput dirInput ->
                ...
                def dest = transformInvocation.outputProvider.getContentLocation(dirInput.file.name
                        , dirInput.contentTypes
                        , dirInput.scopes
                        , Format.JAR)
                mergeJar(dirInput.file, dest)
